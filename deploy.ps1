<#
.SYNOPSIS
    Notion Audit Log → Sentinel: Azure Functions 自動展開スクリプト (v4)
...
# ============================================================
Write-Host ""
Write-Host "Notion Audit Log -> Sentinel: Azure Functions 展開スクリプト" -ForegroundColor White -BackgroundColor DarkBlue
Write-Host ""
...
$funcAppDir = "$PSScriptRoot\function_app"
